      ...
      <div className="mb-3 mt-3">
        ...
        <div className="form-group mb-5">
          ...
          <input
            ...
            value={`${kid.first_name} ${kid.last_name}`}
            aria-label="fullname"
          />
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            rows="7"
            defaultValue={`
            FLU: ${kid.medical_records.flu || ""}
            MMR:${kid.medical_records.mmr || ""}
            POLIO: ${kid.medical_records.polio || ""}
            TB: ${kid.medical_records.tb || ""}
            TETANUS: ${kid.medical_records.tetanus || ""}
            COVID-1st-dose: ${kid.medical_records.covid1 || ""}
            COVID-2nd-dose: ${kid.medical_records.covid2 || ""}`}
          >
          </textarea>
        </div>
